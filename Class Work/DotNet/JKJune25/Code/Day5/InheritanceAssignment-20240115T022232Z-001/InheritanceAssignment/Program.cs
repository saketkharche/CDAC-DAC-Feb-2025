namespace Assignment2
{
    ...
    public abstract class Employee : IDbFunctions
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                if (value=="")
                {
                    Console.WriteLine("Name cannot have blank spaces");
                }
                else
                    this.name = value;
            }
    ...
    public class GeneralManager : Manager, IDbFunctions
    {
        ...
        public GeneralManager(string Name = "default", int DeptNo = 1, string Designation = "Manager", string Perks = "GeneralManager", decimal Basic = 100000) : base(Name, DeptNo, Designation, Basic)
        {
            this.Perks = Perks;
        }
        public override decimal Basic
