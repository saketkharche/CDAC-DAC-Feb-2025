...
public class LoginServlet extends HttpServlet {
	...
	//Can you ever add a parameterized ctor to the 
	//servlet to init state(db config) - NO - since WC manages the life cycle
	//creates singleton instance - using def ctor
